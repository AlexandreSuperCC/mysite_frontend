    ...
    <section class="event-all" :class="{'event-all-show':isShow}">
        <div class="table-box">
            <div class="edit-input" :class="{'edit-input-show': is_edit}">
                ...
                <button @click="editData">Yes</button>
            </div>
            <div class="screen-box">
                <div class="div-select" :class="{'active': active}">
                    ...
                    <div class="div-select-body">
                        <div class="div-option" @click="doSelect(0)">Filter Type</div>
                        <div class="div-option" @click="doSelect(1)">Unfinished</div>
                        <div class="div-option" @click="doSelect(2)">Finished</div>
                        <div class="div-option" @click="doSelect(3)">Cancelled</div>
                    </div>
                </div>
                <input type="text" class="div-search" v-model="screen_title" placeholder="Filter Keywords">
            </div>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            getTypeName(){
                const self = this;
                return self.getType(self.screen_type) || 'Filter Type';
            }
        },
        methods:{
            doSelect(type){
            ...
            editData(){
                ...
                if(this.info.content){
                    ...
                    this.is_edit = false;
                    ElMessageBox.alert("Saving succeeds！ ",{
