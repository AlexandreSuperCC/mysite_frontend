<template>
    <div class="event-content">
        <div class="event-tab" @click="changeCollapse(0,$event)">Unfinished
        ...
        <div class="event-box" :style="{'height':'auto','display':'block'}">
            <ul>
                <li class="event-list" v-for="value in getToDo" :key="value.id">
                    ...
                    <button class="cancel-btn" @click="moveCancel(value.id)">Cancel</button>
                </li>
            </ul>
        </div>

        <div class="event-tab" @click="changeCollapse(1,$event)">Finished
        ...
        <div class="event-tab" @click="changeCollapse(2,$event)">Cancelled
        ...
        <div class="event-box" :class="{'event-box-hide': false}">
            <ul>
                <li class="event-list" v-for="value in getCancel" :key="value.id">
                    ...
                    <button class="cancel-btn" @click="moveToDo(value.id)">Restore</button>
                </li>
            </ul>
        </div>
